// Correspondances minimales réservées aux quatre decks de démonstration.
// Les cartes collectionnables utilisent directement leur champ art dans les JSON.
export const DEMO_ART_BY_NAME = Object.freeze({
  "Académie aldori": {
